## 最大的区别是GET发送一次请求，POST发送两次请求

#### 1、HTTP是什么？
- HTTP是一个客户端和服务器端请求和应答的标准。是基于TCP/IP的关于数据如何在万维网中如何通信的协议。
...
#### 4、POST需要两步，时间上消耗的要多一点，看起来GET比POST更有效。但是不推荐用GET替换POST来优化网站性能。为什么呢？
